package com.chinaroad.transfer.session;
...
import com.chinaroad.transfer.Pushable;
				...
				try {
					...
					if (len < 0) {
					    ...
					    if (!buf.hasRemaining()) {
                            ...
                            buf.position(buf.position() + len);    // new position
                        }
					}
